 ...
 */
namespace TrainingBansi\CustomerLoginIp\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'customeripgrid/index/edit';
    const CMS_URL_PATH_DELETE = 'customeripgrid/index/delete';
